#################################################
# Oracle collection, llada-base thread (full denoising, no cache).
#
# GSAI-ML/LLaDA-8B-Base, growing-window decoding, plain lm_eval prompts (no
# chat template) -- matching run_llada_semi.py. num_blocks=1 in most cases.
# Shared scaffolding (prompt prep, checkers, output layout) lives in
# collect_metrics_common; this file owns only the decoding loop.
#
# Usage:
#   python run_collect_metrics_llada_base.py \
#       --path_mockup benchmark_mockup/mockup_gsm8k_5shot_p10.csv \
#       --folder_output stats_oracle/llada_base_gsm8k_b1 --len_target 256 --num_blocks 1
#################################################
